...
def make_let_frame(bindings, env):
    ...
    new_bind=bindings
    while new_bind!=nil:
        validate_form(new_bind.first,2,2)
        names=Pair(new_bind.first.first,names)
        vals=Pair(eval_all(new_bind.first.rest,env),vals)
        new_bind=new_bind.rest
